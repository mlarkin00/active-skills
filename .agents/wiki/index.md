...
* [publishing](publishing/index.md) - Contains 3 entries: Editing a skill in this repo does not change what its slash command runs, Removing a skill leaves two kinds of reference, and only one of them may be edited, Deep-research source docs name internal services in prose that no path scan catches.
